...
## CONNECT (3 ways)
1. **OpenClaw bridge:** `http://100.95.66.29:18789/v1/chat/completions` (or `hermes.studex-group.com`)
2. **Agent Access Kit:** https://base44.app/api/apps/69ee5456163ccedcfd976e65/files/mp/public/69ee5456163ccedcfd976e65/c4f351bd2_Studex-Agent-Access-Kit.zip
3. **MCP bridge:** `~/studex-os-pack/mcp-bridge/studex_mcp_bridge.py`
